...
import controller.datastruct.stack.Stack;
import controller.datastruct.stack.StackImplementation;
...
public class LinkedList<E> {
    ...
    // Adds a method to remove the first occurrence of an element
    public boolean remove(E elemento) {
        ...
        while (curr != null) {
            if (curr.getData().equals(elemento)) {
